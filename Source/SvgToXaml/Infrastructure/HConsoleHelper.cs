...
public static class HConsoleHelper
{
    ...
    public static extern bool WriteConsoleInput(IntPtr hConsoleInput, KeyEventStruct[] lpBuffer, int nLength,
    ...
    {
        var stdIn = GetStdHandle(StandardHandle.Input);

        var eventsWritten = 0;

        var data = new[] { new KeyEventStruct() };
