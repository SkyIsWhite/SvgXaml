...
public class InvertableBooleanToVisibilityConverter : IValueConverter
{
    ...
    ///     usage: Visibility="{Binding HasError, Converter={StaticResource InvertableBooleanToVisibilityConverter},
    ...
    private bool InvertParam(object param)
    {
        ...
        throw new InvalidDataException(
            $"{GetType().Name}: not able to convert the ConverterParameter to InvertEnum or Boolean [{param}]");
    }
