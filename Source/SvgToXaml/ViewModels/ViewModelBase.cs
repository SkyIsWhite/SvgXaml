...
public abstract class ViewModelBase : BindableBase
{
    ...
    /// <summary>
    ///     Sofern <paramref name="value" /> ungleich dem Wert in <paramref name="field" /> ist, wird das Member-Feld
    ///     <paramref name="field" /> auf den Wert <paramref name="value" /> gesetzt und ein PropertyChanged-Event für die in
    ///     <paramref name="propertyExpression" /> beschriebene Property ausgelöst.
    /// </summary>
    ...
    ///     Lambda-Ausdruck, der die Property aufruft, deren Name in
    ///     <see cref="BindableBase.PropertyChanged" /> übergeben werden soll.
    ///     <example>Beispiel: <code>()=>Name</code></example>
    /// </param>
