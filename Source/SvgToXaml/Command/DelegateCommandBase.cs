...
/// <summary>
///     An <see cref="T:System.Windows.Input.ICommand" /> whose delegates can be attached for
///     <see cref="M:Microsoft.Practices.Prism.Commands.DelegateCommandBase.Execute(System.Object)" /> and
///     <see cref="M:Microsoft.Practices.Prism.Commands.DelegateCommandBase.CanExecute(System.Object)" />.
/// </summary>
public abstract class DelegateCommandBase : ICommand, IActiveAware
{
    ...
    /// <summary>
    ///     Creates a new instance of a <see cref="T:Microsoft.Practices.Prism.Commands.DelegateCommandBase" />, specifying
    ///     both the execute action and the can execute function.
    /// </summary>
    /// <param name="executeMethod">
    ///     The <see cref="T:System.Action" /> to execute when
    ///     <see cref="M:System.Windows.Input.ICommand.Execute(System.Object)" /> is invoked.
    /// </param>
    /// <param name="canExecuteMethod">
    ///     The <see cref="T:System.Func`2" /> to invoked when
    ///     <see cref="M:System.Windows.Input.ICommand.CanExecute(System.Object)" /> is invoked.
    /// </param>
    ...
    /// <summary>
    ///     Creates a new instance of a <see cref="T:Microsoft.Practices.Prism.Commands.DelegateCommandBase" />, specifying
    ///     both the Execute action as an awaitable Task and the CanExecute function.
    /// </summary>
    /// <param name="executeMethod">
    ///     The <see cref="T:System.Func`2" /> to execute when
    ///     <see cref="M:System.Windows.Input.ICommand.Execute(System.Object)" /> is invoked.
    /// </param>
    /// <param name="canExecuteMethod">
    ///     The <see cref="T:System.Func`2" /> to invoked when
    ...
    /// <summary>
    ///     Raises <see cref="E:Microsoft.Practices.Prism.Commands.DelegateCommandBase.CanExecuteChanged" /> on the UI thread
    ///     so every command invoker
    ///     can requery to check if the command can execute.
    ///     <remarks>
    ///         Note that this will trigger the execution of
    ///         <see cref="M:Microsoft.Practices.Prism.Commands.DelegateCommandBase.CanExecute(System.Object)" /> once for each
    ///         invoker.
    ///     </remarks>
    /// </summary>
