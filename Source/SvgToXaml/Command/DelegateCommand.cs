...
/// <summary>
///     An <see cref="T:System.Windows.Input.ICommand" /> whose delegates do not take any parameters for
///     <see cref="M:Microsoft.Practices.Prism.Commands.DelegateCommand.Execute" /> and
///     <see cref="M:Microsoft.Practices.Prism.Commands.DelegateCommand.CanExecute" />.
/// </summary>
...
{
    /// <summary>
    ///     Creates a new instance of <see cref="T:Microsoft.Practices.Prism.Commands.DelegateCommand" /> with the
    ...
    ///     <see cref="M:System.Windows.Input.ICommand.CanExecute(System.Object)" /> is called
    /// </param>
    ...
    /// <summary>
    ///     Factory method to create a new instance of <see cref="T:Microsoft.Practices.Prism.Commands.DelegateCommand" /> from
...
///     <see cref="M:Microsoft.Practices.Prism.Commands.DelegateCommand`1.Execute(`0)" /> and
///     <see cref="M:Microsoft.Practices.Prism.Commands.DelegateCommand`1.CanExecute(`0)" />.
/// </summary>
...
public class DelegateCommand<T> : DelegateCommandBase
{
        ...
        : base(o => executeMethod((T)o), o => canExecuteMethod((T)o))
    {
        ...
        if (typeInfo.IsValueType && (!typeInfo.IsGenericType || !typeof(Nullable<>).GetTypeInfo()
    ...
    /// <summary>
    ///     Factory method to create a new instance of <see cref="T:Microsoft.Practices.Prism.Commands.DelegateCommand`1" />
    ///     from an awaitable handler method.
    /// </summary>
    /// <param name="executeMethod">Delegate to execute when Execute is called on the command.</param>
    /// <returns>
